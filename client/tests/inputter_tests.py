...
class InputTests(DMTestBase):
    ...
    def test_nested(self):
        ...
        dm.outputs.p1.f2.__fspath__()
        dm.outputs.p1.p2.f3.__fspath__()
        dm.outputs.p1.p2.p3.p4.p5.f6.__fspath__()

        dm.outputs.p1.p2.p3.fnotused
    ...
    def test_with_without_args(self):
        ...
        fpath1 = dm.outputs.f1().__fspath__()
        fpath2 = dm.outputs.f1(meta={'arg': 2}).__fspath__()
        ...
        # Do opposite order
        fpath3 = dm.outputs.f3(meta={'arg': 2}).__fspath__()
        fpath4 = dm.outputs.f3().__fspath__()
    ...
    def test_get_right_datetime(self):
        fpath1 = dm.outputs.f1(timepath='2020/01/03').__fspath__()
        fpath2 = dm.outputs.f1(timepath='2020/01/04').__fspath__()
